...
const ToursPage = () => {
  ...
  const tours = [{
    ...
    schedule: {
      ...
      "Day 4 (Mar 11)": "Ang Trapaeng Thmor to Chong Kran Roy - Wetland reservoir managed by WCS to protect Sarus Cranes (100+ birds). Raptors: Greater Spotted Eagle, Black Kite, Roofed-winged Buzzard, Black-winged Kite, Eastern Marsh and Pied Harriers. Other species: Spotted Wood Owl, Barn Owl, Spotted Owlet, Knob-billed Duck. Mid-afternoon travel to Chong Kran Roy tented camp.",
