...
const ToursPage = () => {
  ...
  const tours = [{
    ...
    schedule: {
      ...
      "Day 5": "Siem Reap to Chong Kran Roy - to visit hide attracting birds: Bar-bellied Pitta, Coral-billed Ground Cuckoo and other in feeding hide. Overnght in Chong Kran Roy.",
