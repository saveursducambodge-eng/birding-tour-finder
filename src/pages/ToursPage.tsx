...
const ToursPage = () => {
  ...
  const tours = [{
    ...
    rating: 4.9,
    schedule: {
      "Day 1": "Bengal Florican Grasslands & BeTreed Adventure\nDepart at 5:00 AM from Siem Reap with your birding guide and driver, arriving at the Bengal Florican Grasslands shortly after sunrise. The grasslands also support many other rare species, including, Singing Bushlark, Oriental Skylark, Oriental Pratincole, Pied/Eastern Marsh Harrier and +50 Species. After the morning birding session, we transfer to BeTreed Adventure. In the late afternoon, we meet a local guide for bird watching at roosting sites near the treehouse before sunset.\n\nOvernight at BeTreed Adventure.",
    ...
    schedule: {
      ...
      "Day 3": "AM Birding at Bengal Florican Grassland, PM Transfer to Tmatboey - 5:00 AM departure from Siem Reap, arrive protected area just after sunrise. Meet Local guides at Bengal Florican site. The critically endangered Bengal Florican mostly displaying in early morning light. Overnight Tbeng Resort",
      "Day 4": "Full Day Birding at Tmatboey (Giant Ibis and White-shouldered Ibis focus) - Two full days birding in forests around Tmatboey for best chances to see both White-shouldered Ibis and Giant Ibis before they leave roost sites early morning to feed in small ponds. Overnight Tbeng Resort.",
    ...
    schedule: {
      ...
      "Day 2": "Full Day Birdwatching at Prek Toal Waterbird Sanctuary is Largest breeding colony of large water birds in Southeast Asia. Target two endangered species: Greater Adjutant and Milky Stork and Over 102 bird species recorded. Overnight Siem Reap hotel",
      "Day 3": "Full Day Birdwatching at Ang Trapeang Thmor (Sarus Cranes focus) - Reservoir built in Angkor Period, rebuilt during Pol Pot regime 1976. Managed by WCS, converted to protected landscape 2016. Unique wetland ecosystem with 100+ species. Overnight Siem Reap hotel",
      "Day 4": "AM Birding at Bengal Florican Grassland, PM Transfer to Tmatboey - 5:00 AM departure from Siem Reap, arrive protected area just after sunrise. Target species is Bengal Florican. Mid-day transfer to Tmatboey (3-4 hours). Overnight Tbeng Resort.",
      "Day 5": "Full Day Birding at Tmatboey (Giant Ibis and White-shouldered Ibis focus) - Best chances to see both White-shouldered Ibis and Giant Ibis before they leave roost sites early morning to feed in small ponds. Overnight in Tbeng Resort.",
      ...
      "Day 7": "AM Final Birding at Tmatboey, Transfer to Kratie (Mekong Wagtail focus) - Final few hours searching for remaining key species. Mid-day Travel to small town of Kratie (4-5 hours). Overnight hotel in Kratie",
      "Day 8": "Kratie to Phnom Penh (Cambodian Tailorbird focus) - Kratie province with Mekong River running 140km, home to Irrawaddy dolphins, fish, birds. 30 minutes from Kratie town to Kapi for Mekong Wagtail and Irrawaddy Dolphins. Afternoon Continue to Phnom Penh to look for Cambodian Tailorbird, endemic species found in 2009 in outskirts of Phnom Penh city. Overnight Phnom Penh",
    ...
    schedule: {
      ...
      "Day 6": "Chong Kran Roy to Siem Reap - Early morning revisit hide for Bar-bellied Pitta, Siberian Blue Robin, Red Junglefowl, Emerald Dove. Mid-afternoon drive back to Siem Reap",
      "Day 7": "BeTreed Adventure & Bengal Florican Grasslands - Visit grasslands near Kampong Thom for critically endangered Bengal Florican and 60+ species recorded. Late afternoon check into BeTreed homestay. Overnight in BeTreed homestay.",
      "Day 8": "Full Day Birding at BeTreed Adventure - Remote ecotourism homestay in Phnom Tnout Phnom Pok Wildlife Sanctuary. 2-3 hours from Bengal Florican Grassland. Conserves 42,000+ hectares dry dipterocarp forest, supports community conservation.  Overnight in Betreed.",
      "Day 9": "BeTreed to Tmatboey (Giant Ibis) - Depart late morning for Tmatboey (2-3 hours through rural farmland). Arrive 3:30 PM, meet local guide. Head into dry deciduous forest for seasonal waterholes where ibises feed and roosting tree. Overnight in Tbeng Resort.",
      "Day 10": "Full Birding Day at Tmatboey - Before sunrise with coffee/tea, set out by foot or 4WD to seasonal wetlands where Giant Ibis feeds at dawn. After breakfast in field, continue birding dry forest trails: woodpeckers, Brown Wood Owl, Spotted Wood Owl. Overnight in Tbeng Resort,",
      "Day 11": "Morning Birding Tmatboey & to Vulture Restaurant - Final hours for remaining key species. Mid-morning transfer to Vulture Restaurant at Boeng Toal (Dung Plet Village). Overnight camping in forest",
      "Day 12": "Vulture Restaurant to Kratie - Birdwatching at Vulture Restaurant is one of most unusual, rewarding wildlife experiences in Southeast Asia. Three critically endangered species: White-rumped Vulture, Slender-billed Vulture, Red-headed Vulture. After morning, continue to Kratie (4 hours). Overnight Kratie.",
      "Day 13": "Kratie to Pursat (Chinese Grassbird) - Kratie province with Mekong River is home to Irrawaddy dolphins, Mekong Wagtail, fish, birds. take only 30 minutes from town to Kapi for Mekong Wagtail and Irrawaddy Dolphins. Afternoon continue to Pursat for Chinese Grassbird and other wetland birds. overnight in Pursat.",
      "Day 14": "Pursat to Phnom Penh - Final morning birding Cambodia. Wake early, breakfast in field in Pursat grasslands. the key species: Chinese Grassbird and Yellow-breasted Bunting. After lunch, drive to Phnom Penh, stopping for Cambodian Tailorbird. Overnight Phnom Penh",
    ...
    description: "The itinerary 15-day is combines Cambodia's remarkable biodiversity with cultural heritage and offering an unforgettable birdwatching adventure in Cambodia. This extensive cross-country journey also serves as a fundraising tour to directly support our conservation and community work. The tour begins in birding sites from Siem Reap to Phnom Penh, including Prek Toal, Ang Trapaeng Thmor, Florican Grasslands, Chong Kran Roy (Bar-bellied Pitta, Coral-billed Ground Cuckoo), BeTreed Adventure (42,000+ hectares dry dipterocarp forest conservation), Tmatboey (Giant Ibis - Cambodia's national bird), Vulture Restaurant (three critically endangered vulture species), Kratie (Mekong Wagtail and Irrawaddy dolphins), Pursat (Chinese Grassbird and Yellow-breasted Bunting), and ends with the endemic Cambodian Tailorbird.",
    ...
    description: "Are you or your team already scheduled for March 8th - 23, 2026 , Pearaing Birding Trails is delighted to offer a special 16-day Cambodia birding expedition. This extensive cross-country journey also serves as a fundraising tour to directly support our conservation and community work. The tour begins in Siem Reap, with birding around the iconic Angkor Archaeological Park, before moving on to the wetlands of the Tonle Sap floodplains and the renowned Prek Toal Waterbird Sanctuary.\nFrom there, the journey continues to key birding sites including Ang Trapeang Thmor, Changkran Roy, the Cambodian Florican Grasslands, and the Northern Plains, with  Boeng Toal Vulture Restaurant highlights at Russey Treb - Gaint Ibis. The adventure then heads east to Kratie, followed by outstanding birding in Keo Seima Wildlife Sanctuary and the Dak Dam Highlands. A final birding stop focuses on the endemic Cambodian Tailorbird site, before concluding the tour in Phnom Penh.",
    ...
    schedule: {
      ...
      "Day 5: Siem Reap to Chong Kran Roy": "Early morning departure to Chong Kran Roy tented camp. Late afternoon visit to a special bird hide targeting Bar-bellied Pitta, Coral-billed Ground Cuckoo, Siamese Fireback. These are very hard-to-see species under normal circumstances. Overnight in tented camp.",
      ...
      "Day 7: Bengal Florican Grasslands to BeTreed Adventure": "Early morning visit to Florican Grasslands near Kampong Thom to see critically endangered Bengal Florican displaying. Target birds include Bengal Florican, and grassland specialists. Late afternoon check-in at BeTreed Adventure eco-lodge in Preah Vihear Province within Phnom Tnout Phnom Pok Wildlife Sanctuary. Overnight at BeTreed jungle lodge.",
      "Day 8: Full Day Birding at BeTreed Adventure": "Full day exploring 42,000+ hectares of dry dipterocarp forest. Dawn trek targeting White-browed Fantail, Scarlet Minivet, Blossom-headed Parakeet, woodpeckers, Crested Serpent Eagle.  Evening viewpoint for raptors. Night walk for owls, nightjars, civets. Overnight at BeTreed.",
      "Day 9: BeTreed to Tmatboey - Giant Ibis": "Final dawn walk at BeTreed. Late morning departure for Tmatboey (2-3 hour drive). Arrival at 3:30 PM, head into dry deciduous forest targeting Giant Ibis. and White-shouldered Ibis. Overnight at Tbeng Resort.",
      "Day 10: Full Day Tmatboey - Giant & White-shouldered Ibis": "Pre-sunrise departure to seasonal wetlands where Giant Ibis feeds at dawn. Afternoon visit to White-shouldered Ibis gathering sites. Evening birding walk for owls and nightjars. Overnight at Tbeng Resort.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredTours.map((tour) => <Card key={tour.id} className="group hover:shadow-xl transition-all duration-300 border-sage-light hover:border-nature-sage overflow-hidden">
              <div className="relative h-48 overflow-hidden">
                <img src={tour.image} alt={tour.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300 border" />
              </div>
