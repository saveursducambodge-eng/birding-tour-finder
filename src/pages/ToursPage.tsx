...
const ToursPage = () => {
  ...
  const tours = [{
    ...
    schedule: {
      ...
      "Day 2": "Full Day Birdwatching at Prek Toal Waterbird Sanctuary - 45 minutes by road + 90 minutes by boat. Largest breeding colony of large water birds in Southeast Asia. Target two endangered species: Greater Adjutant and Milky Stork, see Great Cormorant, Purple Heron, Yellow Bittern, Asian Openbill, Oriental Darter, Grey-headed Fish Eagle and over 150 bird species recorded. Overnight Siem Reap hotel",
    ...
    schedule: {
      ...
      "Day 12": "Vulture Restaurant to Kratie - Birdwatching at Vulture Restaurant is one of most unusual, rewarding wildlife experiences in Southeast Asia. Conservation project run by Dongphlet village community with WCS support. Three critically endangered species: White-rumped Vulture, Slender-billed Vulture, Red-headed Vulture. After morning, continue to Kratie (4 hours). Overnight Kratie.",
      "Day 13": "Kratie to Pursat (Chinese Grassbird) - Kratie province with Mekong River is home to Irrawaddy dolphins, fish, birds. take only 30 minutes from town to Kapi for Mekong Wagtail and Irrawaddy Dolphins. Afternoon continue to Pursat for Chinese Grassbird and other wetland birds. overnight in Pursat.",
