...
import svcBoatTripImg from "@/assets/svc-boat-trip-prek-toal.jpg";
    ...
    <>
      ...
      <section className="py-16 sm:py-20 px-4 md:px-6 lg:px-8 bg-gradient-nature">
        <div className="container mx-auto text-center">
          ...
          <p className="mt-4 text-sm text-muted-foreground">Written by: Mr. Sam (PRBT Guide)        </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="mb-8">
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="aspect-video rounded-xl overflow-hidden">
                <img src={svcBoatTripImg} alt="Boat Trip to Prek Toal" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
