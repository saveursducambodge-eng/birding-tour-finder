...
const ToursPage = () => {
  ...
  const tours = [{
    ...
    rating: 4.9,
    schedule: {
      "Day 1": "Bengal Florican Grasslands & BeTreed Adventure\nDepart at 5:00 AM from Siem Reap with your birding guide and driver, arriving at the Bengal Florican Grasslands shortly after sunrise. Local guides will meet us to search for the critically endangered Bengal Florican, using a combination of vehicle-based birding and short walks. Early morning offers the best chance to observe floricans displaying in the soft morning light.\n\nThe grasslands also support many other rare species, including Manchurian Reed Warbler, Sarus Crane, Singing Bushlark, Oriental Skylark, Common Buttonquail, Asian Pied Starling, Oriental Pratincole, Pied Harrier, Eastern Marsh Harrier, Bluethroat, Red Avadavat, and Lanceolated Warbler.\n\nAfter the morning birding session, we transfer to BeTreed Adventure. In the late afternoon, we meet a local guide for bird watching at roosting sites near the treehouse before sunset.\n\nOvernight at BeTreed Adventure.",
    ...
    schedule: {
      ...
      "Day 9": "BeTreed to Tmatboey (Giant Ibis) - Depart late morning for Tmatboey (2-3 hours through rural farmland). Arrive 3:30 PM, meet local guide. Head into dry deciduous forest for seasonal waterholes where ibises feed: Giant Ibis (Cambodia's national bird, Critically Endangered), White-shouldered Ibis (globally threatened). At 6 PM return, dinner. Optional night spotlighting: Collared Scops Owl, Spotted Owlet, Large-tailed Nightjar, Barn Owl",
      "Day 10": "Full Birding Day at Tmatboey - Before sunrise with coffee/tea, set out by foot or 4WD to seasonal wetlands where Giant Ibis feeds at dawn. After breakfast in field, continue birding dry forest trails: woodpeckers, Brown Wood Owl, Spotted Wood Owl, Brown Fish Owl, Blossom-headed Parakeet.. . Lunch and midday rest. Afternoon visit sites for White-shouldered Ibis, Green Bee-eater until dark.",
    ...
    description: "Join us on this special fixed-departure tour from March 8–23, 2026, during Cambodia's peak dry season. This comprehensive birding adventure explores some of Southeast Asia's richest wetlands, the largest remaining tracts of lowland dry dipterocarp forest, and the region's last surviving seasonally flooded grasslands habitats now found almost nowhere else.\n\nJoin a Group Tour with Fellow Birders\n\nIf a private tour feels a bit expensive, joining a group tour is a great option. Our small-group birding tours bring together birders who share the same passion for nature and wildlife, making the experience more enjoyable and affordable.\n\nTake a look at the group tour schedules below to see if there's a departure that suits you. If you don't find the right one, we can also post a proposed tour for you to help connect with other birders who have similar interests. Once enough people join, the tour can be confirmed and run as a small group.\n\nGroup sizes are kept small so everyone enjoys great guiding, better bird sightings, and a relaxed, friendly atmosphere.",
    ...
    schedule: {
      ...
      "Day 3 (Mar 10)": "Prek Toal Waterbird Sanctuary - Largest breeding colony of large water birds in Southeast Asia: we will looking for: Spot-billed Pelican, Painted Stork, Lesser Adjutant, Greater Adjutant (endangered), Milky Stork (endangered), Great Cormorant, Purple Heron, Yellow Bittern, Asian Openbill, Intermediate Egret, Oriental Darter, Indian Cormorant, White-breasted Waterhen, Grey-headed Fish Eagle, Black-headed Ibis. Lunch at floating restaurant. Overnight Siem Reap",
      "Day 4 (Mar 11)": "Ang Trapaeng Thmor to Chong Kran Roy - Wetland reservoir managed by WCS to protect Sarus Cranes (300+ birds). Raptors: Greater Spotted Eagle, Roofed-winged Buzzard, Black-winged Kite, Eastern Marsh and Pied Harriers. Other species: Black-crowned Night Heron, Spotted Wood Owl, Barn Owl, Spotted Owlet, Knob-billed Duck, Jacanas, Black Kite. Mid-afternoon travel to Chong Kran Roy tented camp.",
      ...
      "Day 6 (Mar 13)": "Florican Grasslands to Prey Veng - Early morning drive to Florican Grasslands. Breakfast in field. Local guides for Bengal Florican (critically endangered, predominantly black males strutting). Blue-tailed Bee-eater, Singing Bushlark, Oriental Skylark, Striated Grassbird, Manchurian Reed Warbler (restricted global range), Sarus Cranes, Oriental Pratincole, Eastern Marsh Harrier, Streaked Weaver, Barred and Small Buttonquail. Journey to Prey Veng. May spot Collared Falconet or White-rumped Falcon. Mid-afternoon arrive simple eco-lodge at Prey Veng alongside ancient Khmer Baray in dry dipterocarp forest.",
    ...
    schedule: {
      ...
      "Day 2: Full Day Birding at Angkor Wat Complex": "Combine culture and birding as you explore the Angkor Wat complex and its surrounding forests. Target species include Forest Wagtail, White-throated Rock Thrush, Hainan Blue Flycatcher, Asian Barred Owlet, Black Baza, Oriental Pied Hornbill, Common Hill Myna, Lineated Barbet, Red-breasted Parakeet, Shikra, Alexandrine Parakeet, Ashy Minivet, and more than 60 species",
      "Day 3: Full Day Birding at Prek Toal Waterbird Sanctuary": "Boat trip to Prek Toal, one of Southeast Asia's most important bird sanctuaries on Tonle Sap Lake. The area hosts the largest breeding colonies of large waterbirds in the region. Highlights include Spot-billed Pelican, Painted Stork, Milky Stork, Greater and Lesser Adjutants, Oriental Darter, Black-headed Ibis, and Grey-headed Fish Eagle.\n\nAfternoon birding takes place in nearby farmland with lotus ponds and rice fields, where we look for warblers, bitterns, pratincoles, snipes, and other wetland birds.\nOvernight in Siem Reap.",
      "Day 4: Full Day Birding at Ang Trapaeng Thmor": "Visit Ang Trapaeng Thmor wetland reserve to see over 50 Sarus Cranes and other wetland species. This WCS-managed reserve provides excellent views of concentrated waterbirds. Target species include Sarus Crane, Black-headed Ibis, Painted Stork, Spot-billed Pelican, Oriental Darter, Asian Openbill, Lesser Adjutant, Oriental Plover, Greater Spotted Eagle, Rufous-winged Buzzard, Plain Prinia, Yellow-bellied Prinia, Oriental Reed Warbler, Red Avadavat, and various owls. Overnight in Siem Reap.",
