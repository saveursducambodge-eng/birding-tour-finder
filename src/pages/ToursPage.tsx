...
const ToursPage = () => {
  ...
  const tours = [{
    ...
    image: bird1,
    images: [bird1, pearaingBio2, pearaingBio3, pearaingBio4, pearaingBio5, pearaingBio7, pearaingBio8, pearaingBio9, pearaingBio10],
    category: "cultural",
  ...
  return <>
      ...
      {/* Plan Your Trip — Suggested Itineraries (hidden) */}
      <section id="plan-your-trip" className="hidden py-12 sm:py-16 lg:py-20 px-4 bg-sage-light/40 scroll-mt-24">
