...
const BengalFloricanPage = () => (
  <SpeciesLandingPage
    ...
    title="Bengal Florican Cambodia | Tonle Sap Grassland Birding | Pearaing Birding Trails"
    ...
    sections={[
      ...
      },
      {
        ...
        body: "Pearaing Birding Trails runs dedicated half-day and full-day Bengal Florican trips from Siem Reap, and includes the grassland as the opening morning of its 3-day Russey Treb / Giant Ibis tour. The site also features in 7- to 15-day Cambodia birding grand tours.",
      },
      {
