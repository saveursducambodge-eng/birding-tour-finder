...
const ToursPage = () => {
  ...
  const tours = [{
    ...
    description: "Welcome to BeTreed Adventures, a peaceful eco-lodge in Preah Vihear Province, Cambodia. Just three hours from Siem Reap, between the ancient temples of Koh Ker and Preah Khan of Kampong Svay, BeTreed is the perfect place to enjoy nature, explore the forest, and experience a quieter side of Cambodia away from the crowds..\n\nWorking closely with local communities, BeTreed supports conservation of the 42,000-hectare Phnom Tnout–Phnom Pok Wildlife Sanctuary, a unique dry dipterocarp forest landscape. Your visit directly contributes to protecting wildlife and forests while supporting local livelihoods.\n\nActivities are tailored to your interests and may include birdwatching, wildlife tracking, jungle hiking, night walks, and visits to Angkorian temple ruins. Guests may encounter birds, deer, macaques, langurs, gibbons, squirrels, and even banteng.\n\n\u00a0Common target species include Lineated Barbet, Coppersmith Barbet, Greater Racket-tailed Drongo, Black-naped Oriole, Scarlet Minivet, Common Flameback, White-throated Kingfisher, Asian Green Bee-eater, Oriental Pied Hornbill, Alexandrine Parakeet, Blossom-headed Parakeet, Red-breasted Parakeet, White-throated Rock Thrush, Forest Wagtail, Asian Brown Flycatcher, and Brown-backed Needletail during migration. Lucky visitors may also spot Black Baza, Shikra, or other forest raptors soaring above the trees.\u00a0",
    duration: "3 Days / 2 Nights",
    difficulty: "Moderate",
    groupSize: "2-8 people",
    price: "$ Per Person",
