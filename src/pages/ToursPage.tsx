...
const ToursPage = () => {
  ...
  const tours = [{
    ...
    schedule: {
      ...
      "Day 2": "Wildlife & Forest Exploration at BeTreed - Full day dedicated to exploring BeTreed's diverse habitats from dry deciduous to evergreen forest. Scarlet Minivet, Small Minivet, Indochinese Roller, Indochinese Bushlark, White-rumped Pygmy-Falcon, Rufous-winged Buzzard,  Collared Scope-owl, Savanna Nightjar, Rufous-bellied Woodpecker, Black-headed Woodpecker, and Great Slaty Woodpecker.\n\n Overnight again at BeTreed Adventure",
