  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Cambodia Birding Tours custom colors
        nature: {
          forest: "hsl(var(--forest-green))",
          "forest-light": "hsl(var(--forest-green-light))",
          sage: "hsl(var(--nature-sage))",
          "sage-light": "hsl(var(--sage-light))",
          "sage-pale": "hsl(var(--nature-sage-pale))",
          "sage-pale-hover": "hsl(var(--nature-sage-pale-hover))",
          "sage-mist": "hsl(var(--nature-sage-mist))",
          "sage-mist-hover": "hsl(var(--nature-sage-mist-hover))",
          "sage-soft": "hsl(var(--nature-sage-soft))",
