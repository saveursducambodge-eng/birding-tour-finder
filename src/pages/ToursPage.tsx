...
const ToursPage = () => {
  ...
  const tours = [{
    ...
    schedule: {
      ...
      "Day 3: Full Day Birding at Prek Toal Waterbird Sanctuary": "Boat trip to Prek Toal Waterbird Colonies, Highlights include Spot-billed Pelican, Painted Stork, Milky Stork, Greater and Lesser Adjutants. Overnight in Siem Reap.",
