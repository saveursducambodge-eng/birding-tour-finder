                  ...
                  <div className={`${index % 2 === 1 ? 'lg:order-2' : 'lg:order-1'}`}>
                    <div className="relative">
                      <img 
                        ...
                        className="w-full max-w-sm lg:max-w-md mx-auto rounded-2xl shadow-float object-cover aspect-[3/4]"
                      />
                  ...
                  <div className={`${index % 2 === 1 ? 'lg:order-1' : 'lg:order-2'}`}>
                    ...
                    <div className="prose prose-sm sm:prose max-w-none text-muted-foreground space-y-4">
                      {guide.description.map((paragraph, pIndex) => (
                        <p key={pIndex} className={pIndex === guide.description.length - 1 ? "font-medium text-primary" : ""}>
                          {paragraph}
                        </p>
                      ))}
                    </div>
